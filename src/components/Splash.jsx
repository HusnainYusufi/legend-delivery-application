...
export default function Splash() {
  ...
  return (
    <div className="splash fixed inset-0 z-50 bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center">
      <div className="splash-card flex flex-col items-center">
        <div className="splash-logo h-20 w-20 rounded-2xl bg-white flex items-center justify-center mb-6">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 w-14 h-14 rounded-xl flex items-center justify-center">
