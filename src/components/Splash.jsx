...
export default function Splash() {
  ...
  // Timings tuned to finish within ~0.9s (App unmounts splash at ~900ms)
  const roadDuration = 0.45;
  const truckDelay = 0.25;
  const truckDuration = 0.55;
          ...
          <div className="w-full mt-8">
            ...
            >
              ...
              <motion.img
                ...
                initial={{ x: "-42vw", rotate: -2, opacity: 0.9 }}
                animate={{ x: "42vw", rotate: 0, opacity: 1 }}
