...
const resources = {
  en: {
    translation: {
      ...
      submit: "Submit",
      orders_nav: "Orders",
      delivered_nav: "All Delivered",
      orders_title: "My Assigned Orders",
      delivered_title: "Delivered Orders",
      dashboard_title: "Dashboard",
      dashboard_subtitle: "Your SHAHEENE control center",
      dashboard_description: "Track operations at a glance and jump into your most used flows with a single tap.",
      dashboard_live_label: "Live Ops",
      dashboard_live_value: "Shaheene Pulse Active",
      dashboard_stat_active: "Active Today",
      dashboard_stat_delivered: "Delivered",
      dashboard_stat_pending: "Pending",
      dashboard_stat_returns: "Returns",
      dashboard_action_track: "Track an Order",
      dashboard_action_track_sub: "Check status instantly by QR or order number.",
      dashboard_action_orders: "Manage and verify your assigned orders.",
      dashboard_action_delivered: "Review your delivered history and stats.",
      dashboard_action_scan: "Claim packages faster with QR scanning.",
      loading: "Loading…",
  ...
  ar: {
    translation: {
      ...
      menu: "القائمة",
      orders_nav: "الطلبات",
      delivered_nav: "جميع المُسلَّمة",
      orders_title: "طلباتي المعيّنة",
      delivered_title: "الطلبات المسلَّمة",
      dashboard_title: "لوحة التحكم",
      dashboard_subtitle: "مركز تحكم شاهين",
      dashboard_description: "تابع العمليات بسرعة وانتقل إلى أهم المهام بنقرة واحدة.",
      dashboard_live_label: "العمليات المباشرة",
      dashboard_live_value: "نبض شاهين نشط",
      dashboard_stat_active: "نشط اليوم",
      dashboard_stat_delivered: "المُسلَّمة",
      dashboard_stat_pending: "قيد الانتظار",
      dashboard_stat_returns: "المرتجعات",
      dashboard_action_track: "تتبع طلب",
      dashboard_action_track_sub: "اعرف الحالة فورًا عبر QR أو رقم الطلب.",
      dashboard_action_orders: "إدارة الطلبات المعيّنة والتحقق منها.",
      dashboard_action_delivered: "مراجعة سجل الطلبات المسلَّمة.",
      dashboard_action_scan: "مطالبة أسرع عبر مسح QR.",
